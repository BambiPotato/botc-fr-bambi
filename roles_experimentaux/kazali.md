...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./kazali.html" style="text-decoration:none;">
    <img src="../images/Icon_kazali.png" alt="Kazali" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#d45b5b; font-weight:bold; font-size:22px;">Kazali</span>
  </a>
</div>
...
<ul style="margin-left:40px; color:#f5f5f5; font-size:18px; line-height:1.7;">
  ...
  <li>
    ...
    <a href="../roles_experimentauxs/bountyhunter.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Chasseur de Primes</a>  
