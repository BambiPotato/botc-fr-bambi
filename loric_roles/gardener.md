...
<p style="color:#f5f5f5; font-size:18px; line-height:1.7;">
Ajoutez le <strong>Gardener</strong> pour permettre au Conteur de choisir quel rôle sera attribué à un ou plusieurs joueurs avant le début de la partie.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  <li>Le <strong>Gardener</strong> doit être annoncé au début de la partie.</li>
  ...
  <li>Le <strong>Gardener</strong> est conçu pour l’application officielle et les scripts personnalisés.</li>
</ul>
...
<p style="color:#f5f5f5; font-size:18px; line-height:1.7;">
Avant le début de la partie, déclarez que le <strong>Gardener</strong> est en jeu.  
Décidez quels joueurs recevront les rôles affectés par le Gardener, puis assignez ou échangez les jetons selon votre choix.  
Une fois les rôles distribués, lancez la partie normalement.  
Le <strong>Gardener</strong> ne modifie rien durant la partie, il agit uniquement sur la distribution initiale.
</p>
