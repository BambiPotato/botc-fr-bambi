...
<p style="color:#f5f5f5; font-size:18px; line-height:1.7; margin:0 40px;">
  ...
  il sauve des joueurs de la potence et perturbe les certitudes du camp du Bien.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  <li>Votre priorité est de <strong>protéger votre Démon</strong>.  
      ...
      Vous ne pouvez pas le choisir deux nuits de suite&nbsp;: planifiez vos alternances.</li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Exécutez le même joueur deux jours de suite&nbsp;:  
      l’Avocat du Diable ne peut pas le protéger deux nuits d’affilée.</li>

  <li>Si vous soupçonnez qu’un joueur est protégé,  
      attendez une journée avant de le condamner.</li>

  <li>Une fois identifié, l’<strong>Avocat du Diable</strong> doit mourir rapidement&nbsp;:  
      c’est l’un des Sbires les plus dangereux de <em>Bad Moon Rising</em>.</li>
</ul>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  <li>Bluffer ce rôle peut faire peur au camp du Bien&nbsp;:  
      ils hésiteront à exécuter, de peur que la victime ne survive.</li>
  ...
  <li>Si vous êtes un autre
      <a href="../sbires.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Sbire</a>,  
      mentionner la présence possible d’un Avocat du Diable  
      permet de détourner les soupçons de votre vrai rôle.</li>
</ul>
