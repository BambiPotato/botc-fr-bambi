...
<div style="text-align:center; margin: 20px 0;">
  <a href="./fisherman.html" style="text-decoration:none;">
    <img src="../images/Icon_fisherman.png" alt="Pêcheur" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#4ea3ff; font-weight:bold; font-size:22px;">Pêcheur</span>
  </a>
</div>
...
## 🎭 <span style="color:#4ea3ff;">Bluffer en tant que Pêcheur</span>
