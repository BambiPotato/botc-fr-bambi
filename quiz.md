...
<div id="q-text" style="color:#ffffff; font-size:20px; font-weight:bold; line-height:1.4; margin-bottom:25px;">Chargement...</div>
...
<a id="role-link" href="#" style="display:inline-block; color:#e0c99d; font-weight:bold; text-decoration:underline; font-size:16px; margin-bottom:15px;">📖 Consulter la fiche du rôle</a>
<div>
<button id="next-btn" onclick="nextQuestion()" style="background:#b58b52; color:#000; border:none; padding:10px 20px; border-radius:6px; font-weight:bold; cursor:pointer; font-size:15px;">Question suivante →</button>
</div>
</div>
</div>
...
<button onclick="restartQuiz()" style="background:#b58b52; color:#000; border:none; padding:12px 25px; border-radius:8px; font-weight:bold; font-size:16px; cursor:pointer;">Recommencer le Quiz</button>
</div>
</div>
...
function loadQuestion() {
  ...
  for (var i = 0; i < data.options.length; i++) {
    (function(index) {
      ...
      btn.style.cssText = "display:block; width:100%; background:#221a14; border:1px solid #b58b52; color:#f5f5f5; padding:14px; margin-bottom:12px; border-radius:8px; font-size:16px; text-align:left; cursor:pointer;";
