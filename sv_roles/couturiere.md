...
- La Couturière apprend si deux joueurs appartiennent à la même équipe.
- Elle ne reçoit cette information qu’une seule fois par partie ; 
- elle a donc tout intérêt à choisir soigneusement le moment et les joueurs concernés.
- Elle peut choisir **des joueurs vivants, morts ou même des Voyageurs**.
...
- **Lors de remière nuit :**  
  - la Couturière choisit le [Barbier](barbier.md) et l’[Horloger](horloger.md).  
  - Comme ils sont tous deux bons, elle apprend **« oui »**.  

- **Durant les trois premières nuits :** 
  - la Couturière choisit de ne pas utiliser son pouvoir. 
- Durant la quatrième nuit, elle choisit deux joueurs, qui sont le [<span style="color:red;">Fang Gu</span>](fanggu.md) 
 - et la [Dulcinée](dulcinee.md).  
  Comme ils ne sont pas dans la même équipe, elle apprend **« non »**.  

- **Exemple de transformation :**  
  - La [<span style="color:red;">Pit-Hag</span>](pithag.md) transforme le [Mathématicien](mathematicien.md) 
  en [<span style="color:red;">Sorcière</span>](sorciere.md), mais ce dernier reste bon.  
  - Plus tard, la Couturière choisit la [<span style="color:red;">Sorcière</span>](sorciere.md) et le [Crieur](crieur.md).  
