...
4. [Faire grandir votre communauté Clocktower](#4-faire-grandir-ta-communauté-clocktower)  
...
Votre objectif n’est pas seulement de faire respecter les règles, mais aussi de s’assurer que chaque joueur et joueuse vit une expérience mémorable, cohérente et amusante.
...
Par exemple, si tous les joueurs et joueuses restants sont des <span style="color:red;">maléfiques</span>, alors le <span style="color:blue;">Bien</span> ne peut plus nominer le <span style="color:red;">Démon</span> : le <span style="color:red;">Mal</span> gagne.

Souvent, lorsqu’il reste **quatre joueurs(ses) vivants(es)**, et que les bons exécutent un(e) joueur(se) qui n'est pas <span style="color:red;">maléfique</span>, vous pouvez **terminer la partie immédiatement**.  
...
👉 Utilise ton **jugement de Conteur** : si une possibilité de retournement existe, même infime, laisse la partie continuer.

---

### 👁️ Confirmer les choix des joueurs

Pendant la nuit, lorsque les joueurs et les joueuses font un choix, **confirme-le avec un geste clair** (pointe du doigt vers le bas).  
Certains joueurs(ses) pointent trop vite, ou d’un angle ambigu : plutôt que de deviner, **déplacez-vous** vers la personne qu’ils semblent viser, **pointez clairement vers elle**, et attendez leur hochement de tête pour valider.  
Puis hoche la tête en retour pour confirmer que vous êtes d’accord.  
...
Si vous marchez toujours vers la même zone du cercle au début de chaque nuit, ou si vos chaussures font du bruit, les joueurs(ses) pourraient remarquer un schéma et **déduire la position du <span style="color:red;">Démon</span>**.

💡 Pour éviter ça : variez vos déplacements, faites quelques pas “gratuits” de temps en temps, et changez de rythme.  
Ainsi, les joueurs(ses) ne pourront jamais relier un bruit ou un mouvement à une action spécifique.
...
Quand un joueur <span style="color:red;">maléfique</span> bluffe en prétendant être l’un d’eux, **fais semblant** de manipuler les jetons de la même manière.  
Ainsi, même les vétérans ne pourront pas deviner qui bluffe ou non en observant tes gestes.

---

### 🤫 Réveiller les bons joueurs discrètement

Réveillez les joueurs et les joueuses par un **tapotement doux** sur l’épaule ou le genou.  
Si votre geste fait du bruit, les voisins pourraient entendre et en déduire quelque chose.  
...
Les bords surélevés servent à cacher son contenu, mais si vous l’inclinez trop, un(e) joueur(se) pourrait **voir les jetons à l’intérieur**.  
Assurez-vous que les joueurs(ses) soient assis(ses) légèrement plus bas que le niveau du Grimoire.

Tenez-le par sa **colonne centrale**, au-dessus ou en dessous : vous garderez ainsi une main libre pour déplacer les jetons.  
Ne le prennez jamais uniquement par les bords, sinon le livre pourrait se refermer brusquement et envoyer les jetons voler !
...
Vous n'avez pas besoin d’occuper la scène, votre rôle est de guider, pas de dominer — mais **votre présence centrale** signale aux joueurs(ses) que quelque chose d’important se passe.
...
Si elle a avantagé les perdants, **félicitez davantage les vainqueurs**.  
...
### 😴 Oublier de réveiller un joueur

Si vous oubliez de réveiller un joueur ou une joueuse pendant la nuit (par exemple un <a href="./tb_roles/majordome.html" style="color:blue;">Majordome</a>), deux solutions s’offrent à vous :  
- remettre tous les joueurs “à dormir” et **réveiller seulement** celui ou celle concerné(e),  
...
Un bon <span style="color:#d4a76a;">Conteur</span> n’est **jamais pressé**.  
Pendant la phase de nuit, installe-vous, respirez, vérifiez deux fois l’ordre d’action.  
...
Répondez **en privé** aux questions des joueurs(ses), surtout quand elles concernent leur rôle.  
