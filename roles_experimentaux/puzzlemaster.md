...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Si la devinette est correcte, la conteuse indique en secret au Maître des Puzzles quel joueur est le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.</li>

  <li>Si la devinette est incorrecte, la conteuse indique en secret au Maître des Puzzles un autre joueur qui n’est pas le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.</li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Si le joueur deviné est effectivement marqué <strong>IVRE</strong>,  
      indiquez en secret au Maître des Puzzles quel joueur est le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.</li>

  <li>Sinon, indiquez en secret le nom d’un joueur qui n’est pas le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.</li>
...
<p style="color:#f5f5f5; font-size:18px; line-height:1.7;">
Vous pouvez techniquement rendre un <span style="color:#d45b5b; font-weight:bold;">Sbire</span> ou le <span style="color:#d45b5b; font-weight:bold;">Démon</span> ivre avec cette capacité,  
...
En secret, la conteuse lui dit : « Alex est le <span style="color:#d45b5b; font-weight:bold;">Démon</span>. »
</p>
...
La conteuse lui dit en secret : « Emilien est le <span style="color:#d45b5b; font-weight:bold;">Démon</span>. »  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Ne vous révélez pas immédiatement comme Maître des Puzzles :  
      un <span style="color:#d45b5b; font-weight:bold;">Démon</span> a tout intérêt à vous tuer tôt.  
  ...
  <li>Une fois votre devinette utilisée, l’information obtenue mérite souvent une exécution.  
      Si votre cible est réellement le <span style="color:#d45b5b; font-weight:bold;">Démon</span>, le Bien gagne immédiatement.  
  ...
  <li>Suivez les conséquences de votre révélation :  
      si la personne que vous pensiez être le <span style="color:#d45b5b; font-weight:bold;">Démon</span> est exécutée  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Le Maître des Puzzles ajoute un joueur ivre dans l’équipe du Bien,  
      ...
      idéal pour protéger un <span style="color:#d45b5b; font-weight:bold;">Démon</span> mis en cause.</li>

  <li>Gardez votre « grande révélation » pour un moment clé :  
      annoncer une devinette spectaculaire qui pointe un <span style="color:#d45b5b; font-weight:bold;">Démon</span> supposé  
  ...
  <li>Pour obtenir une exécution « gratuite »,  
      ...
      et annoncez qu’elle est ivre et que tel autre joueur est le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.  
  ...
  <li>Vous pouvez aussi faire l’inverse :  
      ...
      obtenez une fausse info, puis désignez votre véritable <span style="color:#d45b5b; font-weight:bold;">Démon</span>  
  ...
  <li>Le Maître des Puzzles est une distraction parfaite pour un <span style="color:#d45b5b; font-weight:bold;">Sbire</span> :  
      si tout le monde débat de qui est ivre et de la fiabilité des infos,  
      on parle moins de qui est réellement le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.</li>
  ...
  <li>Si vous êtes maléfique et craignez qu’un vrai Maître des Puzzles vous démasque,  
      ...
      il ne découvrira pas le vrai <span style="color:#d45b5b; font-weight:bold;">Démon</span>  
