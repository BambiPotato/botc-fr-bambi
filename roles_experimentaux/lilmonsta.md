...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Si le joueur qui « est le Démon » <strong>meurt</strong>  
  ...
  <li>Un Sbire qui garde le P’tit Monstre  
      conserve sa capacité de <a href="../sbires.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Sbire</a>.</li>

  <li>Le <strong>P’tit Monstre</strong> n’est pas un vrai joueur :  
      il ne peut pas être ivre ou empoisonné.</li>
...
<ul style="margin-left:40px; color:#f5f5f5; font-size:18px; line-height:1.7;">
  ...
  <li>
    ...
    et que le Démon choisit le <strong>P’tit Monstre</strong>,  
    il choisit aussi un <a href="../sbires.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Sbire</a>  
    dont le rôle change.
  </li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li><strong>Chaque nuit :</strong>
    <ul style="margin-left:20px;">
      ...
      <li>si ce n’est pas la première nuit,  
          choisissez éventuellement un joueur qui meurt cette nuit  
          (et marquez-le comme mort).</li>
    </ul>
  </li>

  <li><strong>Mort du « Démon » :</strong>
    <ul style="margin-left:20px;">
      <li>le joueur marqué <strong>EST LE DÉMON</strong>  
          est traité comme le Démon pour toutes les capacités ;</li>
      <li>si ce joueur meurt,  
  ...
  <li><strong>Équilibre de fin de partie :</strong>
    <ul style="margin-left:20px;">
      <li>il est souvent nécessaire  
          de faire mourir un ou deux Sbires la nuit  
          pour garder la partie équitable ;</li>
      <li>essayez de faire en sorte qu’il ne reste  
          qu’<strong>un seul Sbire vivant</strong>  
          lors du dernier jour,  
          afin que les choix du village restent justes  
          et compréhensibles.</li>
    </ul>
  </li>
...
<p style="color:#f5f5f5; font-size:18px; line-height:1.7;">
L’<a href="../tb_roles/poisoner.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Empoisonneur</a>  
et la <a href="../roles_experimentaux/widow.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Veuve</a> se réveillent.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>L’une des grandes forces du <strong>P’tit Monstre</strong>,  
      ...
      l’<a href="../tb_roles/poisoner.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Empoisonneur</a>,  
      la <a href="../sv_roles/sorciere.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Sorcière</a>  
      ou le <a href="../bmr_roles/godfather.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Parrain</a>.</li>

  <li>Les joueurs bons vont observer  
  ...
  <li>Vous pouvez confier le P’tit Monstre  
      ...
      il peut chercher à se faire exécuter  
      pour offrir la victoire au Bien.</li>

  <li>Si un <a href="../roles_experimentaux/bountyhunter.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Chasseur de Primes</a>  
  ...
  <li>Si vous jouez avec le jeton physique du P’tit Monstre,  
      ...
      il sera difficile de l’expliquer  
      sans avouer que vous gardez un petit Démon.</li>

  <li>Le Conteur choisit chaque nuit qui meurt.  
      Il peut décider de faire mourir des Sbires  
...
##  <span style="color:#d45b5b;">Combattre le P'tit Monstre</span>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Dans une partie avec le <strong>P’tit Monstre</strong>,  
      ...
      cela peut indiquer que les Sbires improvisent.</li>

  <li>La <a href="../sv_roles/flowergirl.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Fleuriste</a>  
      et la <a href="../tb_roles/voyante.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Voyante</a>  
  ...
  <li>Une fois que vous pensez avoir identifié  
      ...
      chaque Sbire mort,  
      c’est un gardien potentiel en moins.</li>

  <li>Surveillez aussi les Villageois maléfiques  
      causés par le  
      ...
      ou un <a href="../roles_experimentaux/politician.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Politicien</a>  
      qui aurait basculé :  
      ils sont des gardiens très dangereux pour vous.</li>
  ...
  <li>Souvenez-vous enfin que dans une partie  
      ...
      qui meurt la nuit,  
      mais le Conteur,  
      souvent pour garder un bon équilibre.  
      Un joueur qui meurt la nuit  
      n’est donc pas automatiquement bon…  
      mais ce n’est pas non plus une preuve de culpabilité.</li>
