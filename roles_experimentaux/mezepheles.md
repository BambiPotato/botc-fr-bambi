...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./mezepheles.html" style="text-decoration:none;">
    <img src="../images/Icon_mezepheles.png" alt="Mezepheles" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#d45b5b; font-weight:bold; font-size:22px;">Mezepheles</span>
  </a>
</div>
