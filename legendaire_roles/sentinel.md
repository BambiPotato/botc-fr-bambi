...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.8; margin-left:24px;">
  ...
  <li>Lors de la mise en place, avant de distribuer les rôles :
    <ul>
      ...
      <li>soit retirez un jeton d’<span style="color:#4ea3ff;">Étranger</span> et ajoutez un jeton de <span style="color:#4ea3ff;">Villageois</span> ;</li>
      <li>soit ne modifiez rien.</li>
    </ul>
  </li>
  <li>Seuls les <strong>conteurs et conteuses</strong> savent si un ajustement a été effectué.</li>
</ul>
...
Ce petit flou suffit à raviver la paranoïa et à offrir de nouvelles stratégies de bluff aux <span style="color:#d45b5b;">maléfiques</span>.
</p>
