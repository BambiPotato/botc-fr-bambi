...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./leviathan.html" style="text-decoration:none;">
    <img src="../images/Icon_leviathan.png" alt="Léviathan" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#d45b5b; font-weight:bold; font-size:22px;">Léviathan</span>
  </a>
</div>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>En revanche, si <strong>plus d’un joueur bon</strong> est exécuté  
      ...
      Seule l’<strong>alignement</strong> compte, pas le rôle en lui-même.</li>
  ...
  <li>Toutes les formes d’<strong>exécution</strong> comptent,  
    ...
    <ul style="margin-left:20px;">
      <li>un joueur exécuté à cause de la  
      ...
      <li>un joueur exécuté parce qu’il révèle  
          être un <a href="../sv_roles/mutant.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Mutant</a>  
...
<ul style="margin-left:40px; color:#f5f5f5; font-size:18px; line-height:1.7;">
  ...
  <li>
    ...
    Si le <strong>Léviathan</strong> nomme et fait exécuter  
  ...
  <li>
    ...
    (différent des nuits précédentes) :  
    un <strong>Ravenkeeper</strong> choisi utilise sa capacité mais ne meurt pas.
  </li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li><strong>Compter les jours :</strong>
    <ul style="margin-left:20px;">
      ...
      <li>marquez le Léviathan avec le rappel <strong>DAY 1</strong> ;</li>
      <li>au début de chaque jour suivant, remplacez-le  
          par <strong>DAY 2</strong>, puis <strong>DAY 3</strong>,  
          <strong>DAY 4</strong>, puis <strong>DAY 5</strong> ;</li>
      <li>si un jour se termine alors que le Léviathan porte le rappel  
          <strong>DAY 5</strong>, annoncez que le Mal gagne.</li>
    </ul>
  </li>
  ...
  <li><strong>Exécutions de joueurs bons :</strong>
    <ul style="margin-left:20px;">
      <li>lorsqu’un joueur <strong>bon</strong> est exécuté,  
          marquez-le avec le rappel <strong>GOOD PLAYER EXECUTED</strong> ;</li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li><strong>Observez quels types de rôles</strong>  
      ...
      ou un <a href="../etrangers.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Étranger</a>.</li>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Exécutez tôt les Sbires dont la capacité  
      ...
      ou un <a href="../tb_roles/spy.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Espion</a>  
  ...
  <li><strong>Partagez vos informations dès le jour 1.</strong>  
      ...
      ces personnages ont de grandes chances  
