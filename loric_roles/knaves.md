...
<div style="text-align:center; margin: 20px 0;">
  <a href="./knaves.html" style="text-decoration:none;">
    <img src="../images/Icon_knaves.png" alt="Knaves" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#7fd1ae; font-weight:bold; font-size:22px;">Knaves</span>
  </a>
</div>

# <span style="color:#7fd1ae; font-weight:bold; font-size:18px;">Knaves</span>
