...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>
    ...
    Un Alchimiste-Espionne n’a pas la capacité d’Espionne et une Espionne est en jeu.
    Après chaque exécution, un Alchimiste-Espionne vivant peut deviner publiquement qu’un joueur vivant est l’Espionne.
    Si c'est correct, le Démon doit choisir l’Espionne cette nuit.
  </li>  
  <li>
    🧞
  ...
  <li>
    ...
    L’Espionne s’enregistre comme maléfique pour l’Ogre.
  </li>  
  <li>
    🧞
