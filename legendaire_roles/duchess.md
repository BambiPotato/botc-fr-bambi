...
Chaque joueur qui rend visite à la <strong>Duchesse</strong> apprend combien de visiteurs sont <span style="color:#d45b5b;">maléfiques</span>, en comptant sa propre personne.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.8; margin-left:24px;">
  ...
  Montrez-leur le jeton de la <strong>Duchesse</strong>, puis indiquez avec vos doigts (0, 1, 2 ou 3) combien de visiteurs sont <span style="color:#d45b5b;">maléfiques</span>.  
...
Chaque visiteur apprend combien de visiteurs sont <span style="color:#d45b5b;">maléfiques</span>, mais l’un d’entre eux reçoit forcément une information erronée,  
