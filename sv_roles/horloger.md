...
- Dans le sens des aiguilles d'une montre ⌚️ à partir du [<span style="color:red">No Dashii</span>](nodashii.md) sont assis le [Rêveur](reveur.md), le [Charmeur de serpent](charmeurdeserpent.md), le [<span style="color:red">Jumeau maléfique</span>](jumeaumalefique.md).
...
Lors de la première nuit, l’Horloger apprend un « 2 », car les <span style="color:purple">Voyageurs</span> maléfiques ne comptent pas comme des  [<span style="color:red">Sbire</span>](../sbires.md).
...
- Essayez de coopérer avec d’autres bons joueurs : certains détectent les alignements maléfiques comme l’[Oracle](oracle.md) ou la [Couturière](couturiere.md)), d’autres identifient directement [<span style="color:red">Démons</span> et [<span style="color:red">Sbire</span>](../sbires.md) (comme la [Fleuriste](fleuriste.md), le [Crieur](crieur.md) ou le [Charmeur de Serpent](charmeurdeserpent.md).
...
- Observez leur comportement, leurs déclarations et les infos qui circulent à leur sujet.
➡️ Les [<span style="color:red">Sbires</span>](../sbires.md) ont souvent plus de mal à se cacher que le <span style="color:red">Démon</span>, ce qui peut être votre meilleure piste.
...
- Donner des informations correctes sur l'Horloger peut s'avérer très utile à l'équipe [<span style="color:red">maléfique</span>. S'ils vous croient bon, ils croiront vos informations et ne vous considéreront donc pas comme un  [<span style="color:red">Sbire</span>](../sbires.md) ou un <span style="color:red">Démon</span> lorsqu'ils découvriront les informations de l'Horloger, et ne parviendront donc pas au Démon lui-même. S'ils vous croient mauvais, ils croiront que vous avez donné de fausses informations et éviteront donc le <span style="color:red">Démon</span> lui-même.

- Survivre au premier jour est crucial si vous incarnez le <span style="color:red">Démon</span> bluffant en tant qu'Horloger. 
Étant le seul personnage de[**Sects &Violets**](../sv.md) à obtenir des informations dès la première nuit, et plus jamais, les bons joueurs débutants auront tendance à vouloir exécuter l'Horloger dès le premier jour. Attendre le deuxième jour, voire plus, pour révéler votre identité d'Horloger peut vous aider à survivre aux premières étapes, plus risquées, de la partie.

- Il est généralement préférable de donner de petits nombres comme fausse information. Si le nombre indiqué est la moitié du nombre de joueurs, cela implique que le <span style="color:red">Démon</span> et le [<span style="color:red">Sbire</span>](../sbires.md) sont assis exactement l'un en face de l'autre, car dans le sens horaire ou antihoraire, les pas d'un joueur aboutissent au même joueur. 
De plus, dans les parties avec plusieurs [<span style="color:red">Sbires</span>](../sbires.md), des nombres élevés peuvent laisser penser que les [<span style="color:red">Sbires</span>](../sbires.md) sont tous assis en groupe, ce que les bons joueurs pourraient ne pas croire. Les petits nombres peuvent être tout aussi déroutants que les grands. 
...
- Si un [<span style="color:red;">Sbire</span>](../sbires.md) actif meurt (comme une [<span style="color:red;">Pit-Hag</span>](pithag.md) ou une [<span style="color:red;">Sorcière</span>](sorciere.md)), cela peut trahir les plans de votre équipe.  
  Vous pouvez utiliser cela à votre avantage pour semer la confusion.  
