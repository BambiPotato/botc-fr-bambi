...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./riot.html" style="text-decoration:none;">
    ...
    <br>
    <span style="color:#d45b5b; font-weight:bold; font-size:22px;">Riot</span>
  </a>
</div>
...
#  <span style="color:#d45b5b; font-weight:bold; font-size:18px;">Riot</span>

<p style="text-align:center; color:#f5f5f5; font-style:italic; font-size:18px; margin-top:-10px;">
  « Larga vida a la revolución ! ¡Mi revolución ! »
</p>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>L’équipe du Bien gagne si <strong>tous les Riot</strong> sont morts.  
...
<ul style="margin-left:40px; color:#f5f5f5; font-size:18px; line-height:1.7;">
  ...
  <li>
    ...
    qu’un seul <strong>Riot</strong> en vie,  
    le Bien gagne.  
    Sinon, le Mal gagne.
  </li>
  ...
  <li><strong>Le 3ème jour : fonctionnement de l’émeute</strong>
    <ul style="margin-left:20px;">
      <li>durant cette journée,  
          ...
          il meurt immédiatement ;</li>
      <li>annoncez qu’il est mort  
          et placez un linceul dès sa nomination ;</li>
      <li>dites-lui alors de <strong>nommer à son tour</strong>  
          un joueur vivant ;</li>
      <li>comptez publiquement : « 3… 2… 1… » ;</li>
      <li>s’il nomme un joueur vivant à temps,  
          appliquez le même processus pour ce nouveau nommé ;</li>
      <li>s’il ne nomme personne avant la fin du compte à rebours,  
          <strong>le Conteur nomine</strong> un joueur vivant à la place.</li>
    </ul>
  </li>
