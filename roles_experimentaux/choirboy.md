...
si celui-ci tue le Roi pendant la nuit.
</p>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  <li>
    ...
    Le Kazali ne peut pas choisir le 
    <a href="../roles_experimentaux/king.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Roi</a> 
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>
    ...
    Techniquement, l’Espion peut être considéré comme le 
    <a href="../roles_experimentaux/king.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Roi</a> 
  ...
  <li>
    ...
    Vous pouvez montrer à l’Enfant de chœur n’importe lequel des joueurs Légions encore en vie  
    comme étant le <span style="color:#d45b5b; font-weight:bold;">Démon</span>.
  </li>

  <li>
    <a href="../roles_experimentaux/lilmonsta.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">P’tit Monstre</a> :  
    L’Enfant de chœur verra la personne qui possède le P’tit Monstre pour le reste de la nuit  
  ...
  <li>
    ...
    Si le Vortox tue le Roi, vous pouvez montrer à l’Enfant de chœur n’importe quel joueur  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Le <a href="../roles_experimentaux/king.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Roi</a> peut être en jeu sans qu’il y ait d’Enfant de chœur.</li>

  <li>Lors de la mise en place, avant de mettre les jetons de rôle dans le sac,  
      si l’Enfant de chœur est en jeu et que le Roi ne l’est pas,  
      retirez un jeton de <span style="color:#4ea3ff; font-weight:bold;">Villageois</span> et ajoutez le jeton du Roi.</li>

  <li>Si un Roi est déjà en jeu, l’Enfant de chœur n’en ajoute pas un deuxième.</li>

  <li>Si le <span style="color:#d45b5b; font-weight:bold;">Démon</span> tue le Roi avec sa capacité nocturne,  
      l’Enfant de chœur apprend quel joueur est le Démon (mais pas son rôle précis).</li>

  <li>Si le Démon nomme et fait exécuter le Roi le jour, cela ne déclenche pas la capacité de l’Enfant de chœur.</li>

  <li>Si un <span style="color:#d45b5b; font-weight:bold;">Sbire</span> tue le Roi, par exemple un 
  ...
  <li>Si le Démon attaque le Roi sans le tuer (par exemple à cause du 
...
<a href="../roles_experimentaux/king.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Roi</a> 
ne l’est pas, remplacez un jeton de <span style="color:#4ea3ff; font-weight:bold;">Villageois</span> par le Roi.  
...
<a href="../tb_roles/moine.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Moine</a> : le Roi survit.  
La nuit d’après, l’Imp attaque de nouveau le Roi, cette fois sans protection : le Roi meurt.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>L’Enfant de chœur est un piège tendu au <span style="color:#d45b5b; font-weight:bold;">Démon</span>.  
      ...
      <a href="../roles_experimentaux/king.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Roi</a>.  
      S’il laisse le Roi vivre trop longtemps, le Roi risque d’obtenir des informations cruciales.</li>
  ...
  <li>Si le Roi se révèle, essayez de lui parler discrètement.  
      ...
      Vous pouvez aussi passer par un joueur de confiance qui parlera au Roi à votre place.</li>
  ...
  <li>Vous pouvez échanger de rôle avec un autre joueur (via un effet de script)  
      ...
      Si le Démon tue ce faux Enfant de chœur puis tue le Roi,  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li>Le <span style="color:#d45b5b; font-weight:bold;">Démon</span> sait s’il y a un 
      ...
      S’il n’y a pas de Roi, un bluff d’Enfant de chœur fonctionne mieux  
      si un autre joueur maléfique prétend être le Roi.  
      Si le Démon (ou un autre Sbire) bluffe Roi, appuyez son bluff en disant à quelques joueurs  
      que vous êtes l’Enfant de chœur.</li>

  <li>S’il y a vraiment un Roi en jeu, prétendez être l’Enfant de chœur auprès de ce Roi.  
      Vous pourrez ainsi savoir s’il existe un véritable Enfant de chœur,  
      ce qui est très utile pour le Démon.  
      S’il n’y a pas de double, le Roi est une cible sûre ;  
  ...
  <li>Bluffer Enfant de chœur mène naturellement à une situation critique  
      si le Roi (vrai ou faux) est tué par le Démon.  
