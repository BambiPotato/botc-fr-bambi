...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./marionette.html" style="text-decoration:none;">
    <img src="../images/Icon_marionette.png" alt="Marionnette" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#d45b5b; font-weight:bold; font-size:22px;">Marionnette</span>
  </a>
</div>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <a href="https://wiki.bloodontheclocktower.com/Marionette"
     target="_blank"
