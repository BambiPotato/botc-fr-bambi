...
<div style="text-align:center; margin: 20px 0;">
  <a href="./stormcatcher.html" style="text-decoration:none;">
    ...
    <br>
    <span style="color:#7fd1ae; font-weight:bold; font-size:50px;">Chasseur d’orages</span>
  </a>
</div>
...
« Annoncez un rôle bon. Si en jeu, il ne peut mourir que par exécution, mais les maléfiques apprennent qui c’est. »
</p>
...
Utilisez le <strong>Chasseur d'orages</strong> pour mettre l’accent sur un rôle bon en particulier.
</p>

<p style="color:#f5f5f5; font-size:20px; line-height:1.7; margin-left:0; padding-left:0;">
• Si vous souhaitez créer un script basé sur les actions ou les informations d’un rôle bon en particulier, si vous voulez que ce rôle participe à chaque partie (ou au moins avoir un joueur maléfique qui se fait passer pour ce rôle), vous pouvez utiliser le <strong>Chasseur d'orages</strong>.<br>
Le rôle choisi sera important dans la partie.<br>
Il fera l’objet de nombreuses discussions et vivra probablement jusqu'au dernier jour.
<br><br>
• Le Conteur annonce que ce rôle ne peut pas mourir autrement que par exécution. Ce rôle peut être en jeu ou pas.<br>
S’il est en jeu, ce joueur bon vit tant que les joueurs bons le souhaitent, car les joueurs maléfiques ne peuvent pas le tuer.<br>
S’il n’est pas en jeu, tous les joueurs maléfiques l’apprennent et n’importe quel joueur maléfique peut se faire passer pour ce rôle. (Bien que cela ne soit pas une obligation.)
</p>
...
<p style="color:#f5f5f5; font-size:20px; line-height:1.7; margin-left:0; padding-left:0;">
Au début de la partie, annoncez que le <strong>Chasseur d’orages</strong> est en jeu, ajoutez son jeton au grimoire, puis déclarez le <span style="color:#4ea3ff; font-weight:bold;">rôle </span> favorisé.
<br><br>
...
- Si un rôle bon est marqué du jeton <strong>« EN SÉCURITÉ »</strong>, réveillez chaque joueur maléfique : montrez au joueur maléfique la tuile <strong>« CE JOUEUR EST »</strong>, le jeton de rôle bon, puis désignez le joueur bon en question. Ensuite, le joueur maléfique se rendort.<br>
...
<p style="color:#f5f5f5; font-size:20px; line-height:1.7; margin-left:0; padding-left:0;">
• Le script est construit autour du <a href="../roles_experimentaux/general.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Général</a>.<br>
...
Après plusieurs jours d’infos et de débats, le village choisit de l’<strong>exécuter</strong> : il meurt.
<br><br>
• Le Conteur souhaite une partie basée autour de l’<a href="../tb_roles/empathique.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Empathe</a>.<br>
Le Chasseur d'orages « favorise », l' <a href="../tb_roles/empathique.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Empathe</a> mais <strong>aucun <a href="../tb_roles/empathique.html" style="color:#4ea3ff; font-weight:bold; text-decoration:none;">Empathe</a> n’est en jeu</strong>.<br>
...
<br><br>
Remarque : le <strong>Chasseur d'orages</strong> ne s’applique qu’aux <strong>rôles bons</strong>.
</p>
