...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.8; margin-left:24px;">
  ...
  <li>Annoncez publiquement quels joueurs sont affectés par le <strong><span style="color:#d4a76a;">Bouddhiste</span></strong>, avec leur consentement.</li>
  ...
  <li>Retirez le <strong><span style="color:#d4a76a;">Bouddhiste</span></strong> à tout moment en le déclarant.</li>
  <li>Si aucun minuteur n’est disponible, estimez les deux minutes au mieux et indiquez quand elles sont écoulées.</li>
  <li>Comme pour l’<a href="./ange.html" style="color:#d4a76a; font-weight:bold; text-decoration:none;">Ange</a> et le <a href="./revolutionary.html" style="color:#d4a76a; font-weight:bold; text-decoration:none;">Révolutionnaire</a>, demandez toujours l’accord d’un joueur avant de l’affecter.  
  Par exemple : « Souhaites-tu être affecté par le Bouddhiste pour cette partie ? Tu maîtrises bien le jeu, et cela laissera les nouveaux découvrir par eux-mêmes. »</li>
</ul>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.8; margin-left:24px;">
  ...
  Pour encourager les nouveaux à parler, le Conteur met le <strong><span style="color:#d4a76a;">Bouddhiste</span></strong> en jeu : Nicolas et Céline doivent garder le silence pendant les deux premières minutes de chaque journée, puis ils peuvent s’exprimer librement.</li>

  <li>Leelou est affectée par le <strong><span style="color:#d4a76a;">Bouddhiste</span></strong>. C’est une <span style="color:#d45b5b; font-weight:bold;">Sbire</span>.  
...
Le <strong><span style="color:#d4a76a;">Bouddhiste</span></strong> encourage les nouveaux joueurs et nouvelles joueuses à parler, à réfléchir par eux-mêmes et à apprendre à jouer activement.  
