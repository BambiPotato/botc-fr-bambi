...
## <span style="color:#4ea3ff;">Oracle</span>
...
- Comme l’Oracle agit  **après l’attaque du [<span style="color:red;">Démon</span>](../demons.md)** chaque nuit,  
...
ainsi que tout autre joueur **maléfique**, comme un Voyageur maléfique ou un Villageois, ou un Étranger devenu maléfique.
- Lorsque vous comptez le nombre de joueurs morts, n’oubliez pas d’inclure les jetons de Villageois et d’Étrangers placés face cachée, ce qui signifie que leur alignement est l’inverse de celui indiqué sur le jeton.
...
- Lors du premier jour : la [Fleuriste](fleuriste.md) est exécutée.  
...
- Dès que vous obtenez un « 1 » ou plus, un joueur maléfique a rejoint le royaume des morts. 
  Soyez extrêmement prudent quant aux joueurs à qui vous parlez. 
  Confiez  vos soupçons aux morts : ils seront incités à se montrer intègres et pourront se charger d'une grande partie des accusations à votre place.
  
- En général, les morts de nuit sont bons, car le [<span style="color:red;">Démon</span>](../demons.md)  
...
- Le [<span style="color:red;">Fang Gu</span>](fanggu.md) et le [<span style="color:red;">Vigormortis</span>](vigormortis.md)  
  peuvent faire **varier vos chiffres** :
  - Le [<span style="color:red;">Fang Gu</span>](fanggu.md) peut transférer son rôle de Démon à un Étranger, 
  provoquera des augmentations inattendues du nombre de  maléfique.  
  - Le [<span style="color:red;">Vigormortis</span>](vigormortis.md) tue parfois ses propres Sbires, ce qui ajoute des morts maléfiques tôt dans la partie.  
...
## <span style="color:#4ea3ff;">Bluffer Oracle</span>  
