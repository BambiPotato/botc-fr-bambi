...
Ajoutez le <strong><span style="color:#d4a76a;">Deus ex Fiasco</span></strong> pour neutraliser les erreurs et gagner en assurance quand vous contez un script difficile.  
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.8; margin-left:24px;">
  ...
  Il annonce qu’une erreur a été faite et que la partie continue.</li>

  <li>Nicolas est <a href="../bmr_roles/shabaloth.html" style="color:#d45b5b; font-weight:bold; text-decoration:none;">Shabaloth</a>.  
  Il tue Céline et Leelou. Le matin, le Conteur annonce par erreur que Nicolas et Tanina sont morts, puis corrige :  
...
<p style="color:#f5f5f5; font-size:18px; line-height:1.8;">
Si vous <strong>n’avez pas</strong> mis le <span style="color:#d4a76a;">Deus ex Fiasco</span> au début et que vous faites une erreur en cours de jeu, <strong>ne l’ajoutez pas</strong> après coup.  
