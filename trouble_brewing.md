...
<!-- CONTENEUR GLOBAL : contenu TB + colonne de droite -->
<div style="display:flex; align-items:flex-start; gap:24px;">

  <!-- COLONNE GAUCHE : tout le contenu TB -->
  <div style="flex:1;">
  ...
  <div style="width:230px; border-left:1px solid #b58b52; padding-left:12px; font-size:16px; line-height:1.7;">
