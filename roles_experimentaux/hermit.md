...
<div style="text-align:center; margin: 20px 0%;">
  <a href="./hermit.html" style="text-decoration:none;">
    <img src="../images/Icon_hermit.png" alt="Ermite" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#4ea3ff; font-weight:bold; font-size:22px;">Ermite</span>
  </a>
</div>
...
# 🕯️ <span style="color:#4ea3ff; font-weight:bold; font-size:18px;">Ermite</span>
