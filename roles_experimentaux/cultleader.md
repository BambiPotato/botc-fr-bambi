...
<p style="color:#f5f5f5; font-size:20px; line-height:1.7;">
• Bluffer le <strong>Chef de secte</strong> peut être très amusant ! En raison de la nature changeante de votre alignement, le village se méfiera naturellement de vous de toute façon, ce qui vous permet d'être plus audacieux et de paraître « maléfique » pendant un jour ou deux.
</p>
...
<p style="text-align:left; font-size:20px; margin-top:00x;">
