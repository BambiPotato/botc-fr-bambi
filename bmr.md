...
<div style="text-align:center; margin-bottom:15px;">
  <a href="./bmr.md" style="text-decoration:none;">
    <img src="./images/Logo_bad_moon_rising-1.png" alt="Bad Moon Rising" width="400" style="border-radius:8px;">
    <br>
    <span style="color:#ffa64d; font-weight:bold; font-size:26px;">Bad Moon Rising</span>
  </a>
</div>
...
<p style="color:#e0c99d; font-size:18px; line-height:1.7;">
Heureusement, beaucoup d’options permettent de garder des joueurs et joueuses en vie bien plus longtemps qu’ils ne l’auraient cru possible.<br>
Mais si l’équipe du Bien ne parvient pas à identifier les Sbires et Démons précis en jeu, leur défaite est presque certaine.
</p>
