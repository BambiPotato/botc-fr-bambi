...
<div style="text-align:center; margin: 20px 0;">
  <a href="./knight.html" style="text-decoration:none;">
    <img src="../images/Icon_knight.png" alt="Chevalier" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#4ea3ff; font-weight:bold; font-size:22px;">Chevalier</span>
  </a>
</div>
