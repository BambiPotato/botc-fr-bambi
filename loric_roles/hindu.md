...
<div style="text-align:center; margin: 20px 0;">
  <a href="./hindu.html" style="text-decoration:none;">
    <img src="../images/Icon_hindu.png" alt="Hindu" width="260" style="border-radius:12px;">
    <br>
    <span style="color:#7fd1ae; font-weight:bold; font-size:22px;">Hindou</span>
  </a>
</div>
...
<ul style="color:#f5f5f5; font-size:18px; line-height:1.7; margin-left:40px;">
  ...
  <li><strong>Révélé :</strong> 18 décembre 2025</li>
  <li><strong>Nom original :</strong>
    <a href="https://wiki.bloodontheclocktower.com/Hindu"
       target="_blank"
