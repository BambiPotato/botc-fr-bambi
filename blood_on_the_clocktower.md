...
<div class="sub-box">
  <p style="color:#f5f5f5; font-size:18px; line-height:1.8; text-align:justify;">
    ...
    Ils veulent sauver le village et exécutent le Démon :
    <br>
...
<ul style="color:#f5f5f5; font-size:19px; line-height:1.9;">
  <li>
    Une grande place est donnée à la <strong>narration</strong> : Ravenswood Bluff, les scripts thématiques et les décisions du conteur créent une histoire unique à chaque partie.
  </li>
